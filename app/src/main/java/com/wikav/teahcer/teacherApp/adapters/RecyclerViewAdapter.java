...
import com.bumptech.glide.request.RequestOptions;
        ...
        import com.wikav.teahcer.teacherApp.activities.AnimeActivity;
        import com.wikav.teahcer.teacherApp.model.Anime;
        import com.wikav.teahcer.teacherApp.model.MyStar;
...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.MyViewHolder> {
 ...
 public RecyclerViewAdapter(Context mContext, List<Anime> mData) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        String Ename = user.get(sessionManger.TID);
        Sid = Ename;
        View view ;
...
//        }
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            ...
            view_container = itemView.findViewById(R.id.containerItems);
